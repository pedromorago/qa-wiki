...
Durante la [migración TestCafe → Playwright](/es/automation/migrating-from-testcafe-to-playwright) usamos Copilot/ChatGPT con una técnica simple que multiplica la calidad del resultado: **el fichero de referencia** (few-shot). En vez de pedir "migra esto a Playwright" en frío:
