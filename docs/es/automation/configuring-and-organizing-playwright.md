...
Playwright paraleliza por fichero (los tests de un mismo fichero van en orden en el mismo worker). Requisito previo: [tests independientes con datos propios](/es/cicd/parallelization-and-sharding).
