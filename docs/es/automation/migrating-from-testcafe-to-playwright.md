...
**POM**: de las tres carpetas por página (UI/Tasks/Questions) a [una clase por página](/es/automation/page-object-model); el objeto global `t` de TestCafe desaparece en favor de métodos sobre locators tipados.
