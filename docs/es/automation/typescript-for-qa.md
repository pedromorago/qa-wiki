...
- **POM de verdad**: clases abstractas, interfaces y herencia estricta ([SOLID en el POM](/es/automation/page-object-model)).
...
El repositorio de tests pasa además por [SonarCloud como cualquier otro repo](/es/cicd/static-analysis) — el código de tests también es código.
...
- [ ] Test en la carpeta de su dominio, con su [metadata completa](/es/automation/configuring-and-organizing-playwright) (tags + ID del gestor)
