...
1. **Integración temprana** — participar en requisitos, diseño y planificación desde el inicio ([shift-left](/estrategia/shift-left-y-madurez)).
...
4. **Decisiones basadas en datos** — métricas: QA como el experto en detectar fortalezas y debilidades del proceso ([causa raíz](/estrategia/causa-raiz-de-bugs), métricas de calidad).
