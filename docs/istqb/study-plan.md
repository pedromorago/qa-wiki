...
The v4.0 syllabus and the four sample exams (A–D) with justified answers, from the [ISTQB website](https://istqb.org/certifications/certified-tester-foundation-level-ctfl-v4-0/) or from your local member board if you prefer studying in your language. It's all free.

## 2. Build the base with this wiki
...
## 4. Terminology: the glossary rules

K1 questions ask for **exact** definitions, and third-party summaries sometimes drift from the official terms. When in doubt, the source of truth is the [official ISTQB glossary](https://glossary.istqb.org/). [This wiki's glossary](/glossary) works as a quick refresher, not as a substitute.

## 5. Sample exams, timed

- Take exams A–D **under real conditions**: 60 minutes, no notes.
