...
Añadir un diálogo nuevo = añadir una subclase, **sin tocar la base** (OCP). TypeScript lo habilita con clases abstractas y herencia — una de las razones para [automatizar en TS](/automatizacion/typescript-para-qa).
