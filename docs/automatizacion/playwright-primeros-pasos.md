...
El flujo maduro: grabar para **descubrir selectores y acciones**, y luego encapsular eso en el [Page Object Model](/automatizacion/page-object-model) con locators nativos (`getByRole`, `getByLabel`, `getByTestId`…), que son los más resilientes.
